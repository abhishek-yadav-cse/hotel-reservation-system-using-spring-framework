...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        Date date = DATE_FORMAT.parse("2018-10-04");
        ...
        this.mockMvc.perform(get("/reservations?date=2018-10-04")).andExpect(status().isOk()).andExpect(content().string(containsString("Test, JUnit")));
